...
class BusInfo(models.Model):
    ...
    arriving_from = models.ForeignKey(BusPickArea,unique=False,on_delete=models.CASCADE)
    depature_at = models.ForeignKey(BusDropArea,unique=False,on_delete=models.CASCADE)
